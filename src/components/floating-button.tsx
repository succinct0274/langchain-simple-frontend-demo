...
export default function FloatingButton({ style, toggleCloseButton }: Props) {

  return (
    <div onClick={() => toggleCloseButton()} style={style} className="text-white shadow-xl flex items-center justify-center p-3 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 z-50 absolute  ">
